...
@extends('layouts.master-gardening')
                            ...
                            <div id="rev_slider_5" class="rev_slider" style="display:none;" data-version="5.4.1">
                                <ul>
                                    <li data-index="rs-3054" data-transition="random-premium" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1000"  data-thumb=""  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                        <img src="{{asset('assets/images/slider/4.png')}}"  alt="Organia"  data-bgposition="left bottom" data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="0" class="rev-slidebg" data-no-retina>
                                        ...
                                        <div class="tp-caption headFont tp-resizeme"
                                            ...
                                            data-frames='[{"delay":2400,"speed":300,"frame":"0","from":"x:-50px;opacity:0;","to":"o:1;","ease":"power3.inOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"power3.inOut"}]'
                                             ...
                                             ><a href="{{url('products')}}" class="organ_btn">Order Now<i class="twi-arrow-right1"></i></a>
                                        </div>
                                        ...
                                        ><img src="{{asset('assets/images/home5/1.png')}}" alt=""></div>
                                    </li>
        ...
        <section class="slider_05">
            <div class="container largeContainer">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="rev_slider_wrapper">
                            <div id="rev_slider_5" class="rev_slider" style="display:none; background: #0c0c0c0d;"
                                data-version="5.4.1">
                                <ul>
                                    <li data-index="rs-3054" data-transition="random-premium" data-slotamount="default"
                                        data-hideafterloop="0" data-hideslideonmobile="off" data-easein="Power3.easeInOut"
                                        data-easeout="Power3.easeInOut" data-masterspeed="1000" data-thumb=""
                                        ...
                                        <img src="{{asset('assets/images/slider/4.png')}}" alt="Organia" data-bgposition="left bottom"
                                            data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="0"
                                            class="rev-slidebg" data-no-retina>
                                        <div class="tp-caption SterlingFont ws_nowrap text-upppercase"
                                            data-x="['left', 'left', 'center', 'center']" data-hoffset="['-35','0','0','0']"
                                            data-y="['middle']" data-voffset="['-120','-120','-145','-135']"
                                            data-fontsize="['18','18','18','18']" data-fontweight="500"
                                            data-lineheight="['30']" data-letterspacing="0"
                                            data-width="['500','500','100%', '100%']" data-height="['auto']"
                                            data-whitesapce="normal" data-color="['#62a403']" data-type="text"
                                            data-responsive_offset="off"
                                            data-frames='[{"delay":1500,"speed":300,"frame":"0","from":"x:-50px;opacity:0;","to":"o:1;","ease":"power3.inOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"power3.inOut"}]'
                                            data-textAlign="['left', 'left', 'center', 'center']"
                                            data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,25,20]"
                                            data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,20,25,20]">100% Organic
                                            Foods
                                        </div>
                                        <div class="tp-caption headFont ws_nowrap"
                                            data-x="['left', 'left', 'center', 'center']" data-hoffset="['-40','0','0','0']"
                                            data-y="['middle']" data-voffset="['-22','-22','-30','-45']"
                                            data-fontsize="['58','50','50','38']" data-fontweight="['800']"
                                            data-lineheight="['75','68','65','52']"
                                            data-letterspacing="['-3','-2','-1.4','-1']"
                                            data-width="['580','580','100%','100%']" data-height="['auto']"
                                            data-whitesapce="['normal']" data-color="['#ffffff']" data-type="text"
                                            data-responsive_offset="off"
                                            data-frames='[{"delay":1800,"speed":300,"frame":"0","from":"x:-50px;opacity:0;","to":"o:1;","ease":"power3.inOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"power3.inOut"}]'
                                            data-textAlign="['left', 'left', 'center', 'center']"
                                            data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,80,20]"
                                            data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,20,80,20]">Organic Veggies
                                            Coock <span class="prcolor" style="color:#313131 !important">Healthy</span>
                                        </div>
                                        <div class="tp-caption headFont tp-resizeme"
                                            data-x="['left', 'left', 'center', 'center']" data-hoffset="['-35','0','0','0']"
                                            data-y="['middle']" data-voffset="['105','105','100','70']"
                                            data-fontsize="['17']" data-fontweight="800" data-lineheight=".8"
                                            data-width="['100%']" data-height="['auto']" data-whitesapce="['normal']"
                                            data-color="['#fff']" data-type="text" data-responsive_offset="off"
                                            data-frames='[{"delay":2400,"speed":300,"frame":"0","from":"x:-50px;opacity:0;","to":"o:1;","ease":"power3.inOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"power3.inOut"}]'
                                            data-textAlign="['left', 'left', 'center', 'center']"
                                            data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                            data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,20,0,0]"><a href="shop.html"
                                                class="organ_btn" style="background: #313131">Know More<i
                                                    class="twi-arrow-right1"></i></a>
                                        </div>
                                        <div class="tp-caption rs-parallaxlevel-1 layerImg"
                                            data-frames='[{"delay":2600,"speed":850,"frame":"0","from":"z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;","to":"o:1;","ease":"power3.inOut"},{"delay":"wait","speed":300,"frame":"999","to":"auto:auto;","ease":"power3.inOut"}]'
                                            data-type="image" data-x="right" data-y="center"
                                            data-hoffset="['-65','0','0','0']" data-voffset="['2','0','0','0']"
                                            data-width="['auto', '450']" data-height="['auto']"
                                            data-visibility="['on', 'on', 'on', 'on']"><img src="assets/images/home5/1.png"
                                                alt=""></div>
                                    </li>
                                    <li data-index="rs-3055" data-transition="random-premium" data-slotamount="default"
                                        data-hideafterloop="0" data-hideslideonmobile="off" data-easein="Power3.easeInOut"
                                        data-easeout="Power3.easeInOut" data-masterspeed="1000" data-thumb=""
                                        data-rotate="0" data-saveperformance="off" data-title="" data-param1=""
                                        data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="ab_content_01">
                            ...
                            <a href="{{url('products')}}" class="organ_btn">Shop Now<i class="twi-arrow-right1"></i></a>
                        </div>
                    </div>
                        ...
                        <div class="tab-content anim-right">
                            <div class="tab-pane fade" id="healthy_food" role="tabpanel">
                                <div class="organTabContent">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="{{asset('assets/images/what-we-do.svg')}}" alt="">
                                        </div>
                            ...
                            <div class="tab-pane fade show active" id="fresh_products" role="tabpanel">
                                <div class="organTabContent">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <img src="{{asset('assets/images/home1/2.png')}}" alt="">
                                        </div>
                                        <div class="col-md-6 clLeft">
                                            <div class="subTitle">Nature Only</div>
                                            <h2 class="secTitle">Econis is a Friendly Organic Store</h2>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav org_pro_tab orgoTab05" role="tablist">
                            <li role="presentation">
                                <a id="prtab01-tab" data-toggle="tab" href="#prtab01" role="tab" aria-controls="prtab01" aria-selected="false"><span>01.</span>Beverages</a>
                            </li>
                            <li role="presentation">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="prtab01" role="tabpanel">
                                <div class="proGalSLiderWrap">
                                    <div class="progallerySLider" id="prtab01-slider">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="product_content04">
                                                        ...
                                                        <h3><a href="{{url('products')}}">Avocado <span>Organic</span></a></h3>
                                                        <p>Broccoli Roses, Alway Fresh And Delicious. 100% Organic</p>
                                                        <a href="{{url('products')}}" class="organ_btn gradinBtn">Add To Cart<i class="twi-arrow-right1"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="proThumb04">
                                                        <img src="{{asset('assets/images/product/ts1.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="product_content04">
                                                        ...
                                                        <h3><a href="{{url('products')}}">Cabbabe <span>Organic</span></a></h3>
                                                        <p>Broccoli Roses, Alway Fresh And Delicious. 100% Organic</p>
                                                        <a href="{{url('products')}}" class="organ_btn gradinBtn">Add To Cart<i class="twi-arrow-right1"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="proThumb04">
                                                        <img src="{{asset('assets/images/product/ts2.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="product_content04">
                                                        ...
                                                        <h3><a href="{{url('products')}}">Fresh <span>Tomato</span></a></h3>
                                                        <p>Broccoli Roses, Alway Fresh And Delicious. 100% Organic</p>
                                                        <a href="{{url('products')}}" class="organ_btn gradinBtn">Add To Cart<i class="twi-arrow-right1"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="proThumb04">
                                                        <img src="{{asset('assets/images/product/ts3.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="product_content04">
                                                        ...
                                                        <h3><a href="{{url('products')}}">Onion <span>Organic</span></a></h3>
                                                        <p>Broccoli Roses, Alway Fresh And Delicious. 100% Organic</p>
                                                        <a href="{{url('products')}}" class="organ_btn gradinBtn">Add To Cart<i class="twi-arrow-right1"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="proThumb04">
                                                        <img src="{{asset('assets/images/product/ts4.png')}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="proGallerySliderThumb" id="prtab01-thumb">
                            ...
                            <div class="tab-pane fade show active" id="prtab02" role="tabpanel">
                                <div class="proGalSLiderWrap">
                                    <div class="progallerySLider" id="prtab02-slider">
                                        <div class="productItem09">
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="product_content04">
                                    ...
                                    <div class="proGallerySliderThumb" id="prtab02-thumb">
                                        <div class="gsThumbItem">
                                            <img src="{{asset('assets/images/product/ts1.png')}}" alt=""/>
                                            <svg xmlns="http://www.w3.org/2000/svg')}}" width="300.000000pt" height="300.000000pt" viewBox="0 0 300.000000 300.000000" preserveAspectRatio="xMidYMid meet">
                                                <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)" stroke="none">
                            ...
                            <div class="tab-pane fade" id="prtab03" role="tabpanel">
                                <div class="proGalSLiderWrap">
                                    <div class="progallerySLider" id="prtab03-slider">
                                        <div class="productItem09">
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="product_content04">
                                    ...
                                    <div class="proGallerySliderThumb" id="prtab03-thumb">
                                        <div class="gsThumbItem">
                                            <img src="{{asset('assets/images/product/ts2.png')}}" alt=""/>
                                            <svg xmlns="http://www.w3.org/2000/svg')}}" width="300.000000pt" height="300.000000pt" viewBox="0 0 300.000000 300.000000" preserveAspectRatio="xMidYMid meet">
                                                <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)" stroke="none">
                            ...
                            <div class="tab-pane fade" id="prtab04" role="tabpanel">
                                <div class="proGalSLiderWrap">
                                    <div class="progallerySLider" id="prtab04-slider">
                                        <div class="productItem09">
                                            <div class="row">
                                                <div class="col-lg-5">
                                                    <div class="product_content04">
                                    ...
                                    <div class="proGallerySliderThumb" id="prtab04-thumb">
                                        <div class="gsThumbItem">
                                            <img src="{{asset('assets/images/product/ts1.png')}}" alt=""/>
                                            <svg xmlns="http://www.w3.org/2000/svg')}}" width="300.000000pt" height="300.000000pt" viewBox="0 0 300.000000 300.000000" preserveAspectRatio="xMidYMid meet">
                                                <g transform="translate(0.000000,300.000000) scale(0.100000,-0.100000)" stroke="none">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav org_pro_tab orgoTab05" role="tablist">
                            ...
                            <li role="presentation">
                                <a id="prtab01-tab"  data-toggle="tab" href="#prtab01" role="tab" aria-controls="prtab01" aria-selected="false"><span>01.</span>{{$products[0]->name ?? ''}}</a>
                            </li>
                            <li role="presentation">
                                <a class="active" id="prtab02-tab" data-toggle="tab" href="#prtab02" role="tab" aria-controls="prtab02" aria-selected="true"><span>02.</span>{{$products[1]->name ?? ''}}</a>
                            </li>
                            <li role="presentation">
                                <a id="prtab03-tab" data-toggle="tab" href="#prtab03" role="tab" aria-controls="prtab03" aria-selected="false"><span>03.</span>{{$products[2]->name ?? ''}}</a>
                            </li>
                            <li role="presentation">
                                <a id="prtab04-tab" data-toggle="tab" href="#prtab04" role="tab" aria-controls="prtab04" aria-selected="false"><span>04.</span>{{$products[3]->name ?? ''}}</a>
                            </li>
                      
                        </ul>
                        <div class="tab-content">
                            @foreach($products as $k => $product)
                            <div class="tab-pane fade {{ ($k == 0) ? 'active show' : '' }}" id="prtab0{{$k + 1}}" role="tabpanel">
                                <div class="proGalSLiderWrap">
                                    <div class="progallerySLider" id="prtab0{{$k + 1}}-slider">
                                    @for($i = 0; $i < count($products); $i++)
                                        <div class="productItem09" style="{{ ($i == 0) ? '' : 'display:none' }}">
                                            <div class="row">
                                                <div class="col-lg-5">
                                                <form action="{{url('add_to_cart')}}" method="POST">
                                                    <div class="product_content04">
                                                        ...
                                                        <input type="hidden" value="0" name="weight_quantity" class="quantity_type" />
                                                        <input type="hidden" value="1" name="quantity" class="quantity_type" />
                                                        @csrf
                                                        <input type="hidden" value="{{$products[$i]->id}}" name="product_id"/> 
                                                        <span class="price">₹{{$products[$i]->offer_price}}</span>
                                                        </div>
                                                        <h3><a href="single-product.html">{{$products[$i]->name}} <span></span></a></h3>
                                                        <p>{{$products[$i]->product_details}} </p>
                                                        <button type="submit" class="organ_btn gradinBtn">Buy Now<i class="twi-arrow-right1"></i></button>
                                                    </div>
                                                </form>
                                                </div>
                                                <div class="col-lg-7">
                                                    <div class="proThumb04">
                                                        <img src="assets/images/product/{{explode(',', $products[$i]->images)[0]}}" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="bl_ctconten">
                            ...
                            <a href="{{env('BLOG_URL')}}" class="organ_btn ob02">View All<i class="twi-arrow-right1"></i></a>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="row grid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="SubsrcribeForm">
                                        <form id="subscribe">
                                            @csrf
                                            <input type="hidden" name="type" id="type" value="gardening">
